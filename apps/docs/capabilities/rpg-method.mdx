...
```bash
TAMP parse-prd .taskmaster/docs/your-prd.txt --research
```
...
4. Let `TAMP expand` break down complex tasks further

### 4. Use Research Mode
```bash
TAMP parse-prd --research
```
...
5. **Parse PRD**: `TAMP parse-prd .taskmaster/docs/your-project.txt --research`
6. **Analyze**: `TAMP analyze-complexity --research`
7. **Expand**: `TAMP expand --all --research`
8. **Start work**: `TAMP next`
