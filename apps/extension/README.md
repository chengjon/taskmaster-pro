...
Transform your AI-driven development workflow with a beautiful, interactive Kanban board directly in VS Code. Seamlessly manage tasks from [Taskmaster AI](https://github.com/chengjon/taskmaster-pro) projects with real-time synchronization and intelligent task management.
...
- **MCP Server Command** - Path to taskmaster-pro executable (default: `npx`)
- **MCP Server Args** - Arguments for the server command (default: `-y`, `taskmaster-pro`)
...
### **Getting Help**
- 📖 **Documentation**: [Taskmaster AI Docs](https://github.com/chengjon/taskmaster-pro)
- 🐛 **Report Issues**: [GitHub Issues](https://github.com/chengjon/taskmaster-pro/issues)
...
- Report issues on [GitHub](https://github.com/chengjon/taskmaster-pro/issues)
