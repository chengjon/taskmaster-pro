...
3. Install the taskmaster-pro package locally:

   ```bash
   # From the root of the claude-TAMP repository
   cd ..
   npm pack
   # This will create a file like taskmaster-pro-0.12.0.tgz

   # Move back to the test directory
   cd test-tm
   npm install ../taskmaster-pro-0.12.0.tgz
   ```
