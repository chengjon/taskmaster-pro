...
Use the `TAMP init` command to run through the guided initialization:
...
TAMP models --set-main gemini-2.5-pro --gemini-cli

# Or use the faster gemini-2.5-flash model
TAMP models --set-main gemini-2.5-flash --gemini-cli
```
