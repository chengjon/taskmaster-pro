...
npm install --save-dev taskmaster-pro
```
...
TAMP models --set-research gpt-5 --codex-cli
...
TAMP parse-prd my-requirements.txt
...
TAMP add-task --prompt="Implement user authentication" --research
```
