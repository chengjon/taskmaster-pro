...
1. **Check Current Installation**
   ...
   which TAMP || echo "Task Master not found"
   
   # Check npm global packages
   npm list -g taskmaster-pro
   ```
...
7. **Quick Test**
   ...
   # Try parsing it
   TAMP parse-prd test-prd.txt -n 3
   ```
...
sudo npm install -g taskmaster-pro
...
npm install -g taskmaster-pro --registry https://registry.npmjs.org/
```
