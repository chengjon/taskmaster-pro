...
1. **Task Specification Review**
   - Retrieve task details using MCP tool `mcp__taskmaster-pro__get_task`
...
1. **Retrieve Task Information**
   ```
   Use mcp__taskmaster-pro__get_task to get full task details
...
- `mcp__taskmaster-pro__get_task`: Get task details
