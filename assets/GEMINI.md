...
**Note:** API keys are configured via `TAMP models --setup`, not in MCP configuration.
...
TAMP models --set-main gemini-2.0-flash-exp
TAMP models --set-fallback gemini-1.5-flash
