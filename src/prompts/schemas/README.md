...
- **GitHub Reference**: `https://github.com/chengjon/taskmaster-pro/blob/main/src/prompts/schemas/prompt-template.schema.json`
...
- **Local Development**: `./src/prompts/schemas/prompt-template.schema.json`
- **GitHub Blob**: `https://github.com/chengjon/taskmaster-pro/blob/main/src/prompts/schemas/prompt-template.schema.json`
